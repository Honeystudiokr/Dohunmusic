...
export const dummyPlaylistArray = [
  {
    id: 1,
    owner: "도헌",
    playlistName: "도헌의 관음드래곤즈 야구응원가 모음",
    songList: getSongsBychannel("도헌"),
  }
];
...
export const dummyChannelList = [
  {
    ...
    name: "도헌",
    songList: getSongsBychannel("도헌"),
    playlistArray: getPlaylistByOwner("도헌"),
  },
];
